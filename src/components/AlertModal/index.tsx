        ...
        <Dialog as="div" tw="relative z-10" onClose={closeModal}>
          ...
          <div tw="fixed inset-0 overflow-y-auto ">
            <div tw="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel tw="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all dark:bg-03">
                  <Dialog.Title as="h3" tw="text-lg font-medium leading-6 ">
                    {alertTitle}
                  </Dialog.Title>
                  <div tw="mt-2">
