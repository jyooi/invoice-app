...
const CheckboxLabel = styled.label(()=>[tw`ml-[13px] text-lg font-bold text-03 cursor-pointer select-none dark:text-white`,
   css`line-height: 15px; /* 100% */
   letter-spacing: -0.25px;
`])


export const Checkbox = ({ isChecked, setIsChecked }: PropType) => {
